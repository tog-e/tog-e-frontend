    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        <Text style={styles.logo}>
          Tog<Text style={styles.logoAccent}>-e</Text>
        </Text>
      ...
      <View style={styles.card}>
        ...
        {screen === "forgot" && (
          <>
            ...
            <Text style={styles.screenSub}>
              Email хаягаа оруулахад код илгээнэ
            </Text>
            <TextInput
              style={styles.input}
              placeholder="Email хаяг"
            ...
            >
              {loading ? (
                ...
                <Text style={styles.btnText}>Код илгээх</Text>
              )}
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setScreen("login")}>
        ...
        {screen === "reset" && (
          <>
            ...
            <Text style={styles.screenSub}>
              Имэйлээр ирсэн кодоо оруулна уу
            </Text>
            <TextInput
              style={styles.input}
              placeholder="Email хаяг"
            ...
            >
              {loading ? (
                ...
                <Text style={styles.btnText}>Нууц үг өөрчлөх</Text>
              )}
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setScreen("login")}>
              <Text style={styles.switchText}>← Буцах</Text>
